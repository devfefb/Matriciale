...
async function gerarComparacaoDetalhada(): Promise<void> {
  try {
    ...
    const caminhoComparacao = path.join(__dirname, './output_validacao/comparacao-detalhada.json');
    ...
    const caminhoCSV = path.join(__dirname, './output_validacao/comparacao-detalhada.csv');
